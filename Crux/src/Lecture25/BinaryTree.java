...
public class BinaryTree {
	...
	public void findPathFromRoot(int key) {
		findPathFromRoot(this.root,key);
	}
	
	private void findPathFromRoot(Node rootNode, int key) {
	    ...
	    while (true) {
	        ...
	        if (topNode.left != null) {
	            stck.push(topNode.left);
	            if (topNode.left.data == key) {
	                break;
	            }
	        } else if (topNodeRight != null) {
	            stck.push(topNodeRight);
	            if (topNodeRight.data == key) {
	                break;
	            }
	        } else {
	            Node lastPoppedNode;
